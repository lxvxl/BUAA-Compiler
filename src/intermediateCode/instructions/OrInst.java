...
public record OrInst(int num, String result, String para1, String para2) implements Inst, Computable {

    public OrInst(String result, String para1, String para2) {
    ...
    public Inst generateEquivalentInst(HashMap<String, String> regMap) {
        return new OrInst(result, Inst.getEquivalentReg(regMap, para1), Inst.getEquivalentReg(regMap, para2));
    }
